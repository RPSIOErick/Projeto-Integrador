...
const createAluno = async (req, res) => {
    try {
        const { Cod_Curso, Representante, Nome, RA, Senha } = req.body;
        
        // Verificar se os dados estão vindo no body
        console.log('Dados recebidos:', { Cod_Curso, Representante, Nome, RA, Senha });

        // Criar o aluno no banco de dados
        const aluno = await Aluno.create({ Cod_Curso, Representante, Nome, RA, Senha });
